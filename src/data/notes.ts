...
export const FAQ_CARDS: FaqCard[] = [
  ...
  {
    id: 'gtir-01',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Gebelik planlıyorum; herkesin tiroid testi yaptırması gerekir mi?',
    cevap: `Gebelik öncesi veya gebelikte herkese rutin tiroid taraması önerilmiyor. Test; tiroid hastalığı/ameliyatı öyküsü, tiroid antikoru pozitifliği, ailede tiroid hastalığı, tip 1 diyabet gibi risk faktörü olanlarda hedefe yönelik yapılır. Güncel kılavuz; yaş, kilo (BMI) ve doğum sayısını tek başına test gerekçesi olmaktan çıkardı.`,
    anahtar: ['gebelikte tiroid taraması', 'gebelik öncesi tiroid testi', 'gebelikte TSH'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-02',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Gebelikte tiroid değeri (TSH) hedefi normalden farklı mı?',
    cevap: `Evet. Gebelikte TSH üst sınırı, gebe olmayan döneme göre biraz daha düşüktür (ilk trimesterde yaklaşık 4.0 mU/L'ye kadar). Tiroid ilacı kullananlarda hedef genellikle 2.5 mU/L'nin altıdır. Bu yüzden gebelik planlarken ve gebelik boyunca tiroid takibi ayrı bir öneme sahiptir.`,
    anahtar: ['gebelikte TSH kaç olmalı', 'gebelik tiroid hedef', 'gebelikte tiroid değeri'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-03',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Tiroid ilacı (levotiroksin) kullanıyorum; gebe kalınca dozum değişir mi?',
    cevap: `Sıklıkla evet. Gebelikte tiroid hormonu ihtiyacı arttığı için levotiroksin dozu genellikle %20-30 oranında artırılır. Gebeliğinizi öğrenir öğrenmez hekiminize danışın; doz erkenden ayarlanır ve TSH yakından izlenir.`,
    anahtar: ['gebelikte levotiroksin dozu', 'tiroid ilacı gebelik', 'gebelikte tiroid ilacı artışı'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-04',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Gebelikte iyot takviyesi almalı mıyım?',
    cevap: `Gebelik ve emzirme döneminde günlük toplam yaklaşık 250 mcg iyot önerilir. Çoğu kadına 150 mcg/gün iyot takviyesi (ideal olarak gebelikten ~3 ay önce başlanarak) önerilir. Çok yüksek alımdan (genellikle >500 mcg/gün) kaçınılmalıdır. Uygun doz hekimle planlanır.`,
    anahtar: ['gebelikte iyot', 'gebelikte iyot takviyesi', 'iyot dozu gebelik'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-05',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Tiroid antikorum (TPO) pozitif ama tiroidim normal; gebelikte ilaç gerekir mi?',
    cevap: `Tiroid fonksiyonu normalken yalnızca antikor pozitifliği için tiroid ilacı (levotiroksin) önerilmez — düşük veya infertilite öyküsü olsa bile. Ancak bu kişilerde gebelikte tiroid yavaşlaması gelişme riski bir miktar arttığından, tiroid fonksiyonu belirli aralıklarla (örneğin 3-6 ayda bir) kontrol edilir.`,
    anahtar: ['TPO antikoru gebelik', 'tiroid antikoru pozitif gebelik', 'gebelikte tiroid antikoru'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-06',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Gebelikte tiroidim sınırda yüksek çıktı; hemen ilaç başlanır mı?',
    cevap: `Hafif yükseklikte genellikle önce test tekrarlanır, çünkü sınırda değerlerin önemli bir kısmı kendiliğinden normale döner. Belirgin yükseklikte (TSH 6 mU/L ve üzeri) tiroid ilacı başlanır. Karar; değerlere, gebelik haftasına ve genel duruma göre birlikte verilir.`,
    anahtar: ['gebelikte tiroid yüksek', 'gebelikte subklinik hipotiroidi', 'gebelikte TSH yüksek'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-07',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Graves (zehirli guatr) hastasıyım; gebelikte tedavi nasıl olur?',
    cevap: `Gebelik planlarken ve ilk aylarda, bebeğe etkisi açısından genellikle propiltiyourasil (PTU) tercih edilir; yaklaşık 16. gebelik haftasına kadar bu ilaç kullanılır. Hastalığı iyi kontrol altında olan bazı kadınlarda ilaç gebelikte dikkatle azaltılıp kesilebilir. Tedavi mutlaka uzman takibinde, kişiye göre planlanır.`,
    anahtar: ['gebelikte Graves', 'gebelikte hipertiroidi', 'gebelikte tiroid ilacı PTU'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'gtir-08',
    kategori: 'Gebelik ve Tiroid',
    soru: 'Doğumdan sonra tiroidim bozulabilir mi?',
    cevap: `Evet, bazı kadınlarda doğumu izleyen ilk yıl içinde geçici tiroid bozukluğu (postpartum tiroidit) görülebilir: önce hafif hızlanma, ardından yavaşlama dönemi olabilir. Hızlanma döneminde genellikle antitiroid ilaç gerekmez; belirti varsa düşük doz beta-bloker kullanılabilir (emzirirken propranolol ve metoprolol güvenli kabul edilir). Yavaşlama döneminde belirti varsa, emziriyorsa ya da yeniden gebelik planlıyorsa tiroid ilacı verilebilir.`,
    anahtar: ['postpartum tiroidit', 'doğum sonrası tiroid', 'emzirirken tiroid'],
    kaynaklar: ['ATA 2026 Gebelik ve Tiroid Hastalıkları Kılavuzu (Korevaar ve ark., Thyroid, 2026)'],
  },
  {
    id: 'htp-01',
    kategori: 'Hipertansiyon (Tansiyon)',
    soru: 'Yeni kılavuzlar tansiyon hedefini değiştirdi mi?',
    cevap: `Güncel Avrupa kılavuzu (2024 ESC), tedavi gören çoğu erişkinde daha sıkı bir üst tansiyon hedefi (yaklaşık 120-129 mmHg) öneriyor — kişi tolere edebildiği ölçüde. Ayrıca 120-139/70-89 aralığı "yükselmiş tansiyon" olarak tanımlanıp risk yüksekse erken önlem öneriliyor. Hedef her zaman yaşa ve genel duruma göre kişiselleştirilir.`,
    anahtar: ['yeni tansiyon hedefi', 'tansiyon kaç olmalı', 'yükselmiş tansiyon'],
    kaynaklar: ['2024 ESC Hipertansiyon Kılavuzu (Eur Heart J, 2024)'],
  },
  {
    id: 'dmp-01',
    kategori: 'Prediyabet ve Diyabet',
    soru: 'Şeker ilacım seçilirken kalbim ve böbreğim de dikkate alınır mı?',
    cevap: `Evet. Güncel yaklaşımda; kalp-damar hastalığı, kalp yetmezliği veya böbrek hastalığı olan diyabetlilerde, kan şekeri değerinden bağımsız olarak kalbi ve böbreği koruduğu kanıtlanmış ilaçlar (SGLT2 inhibitörleri ve/veya GLP-1 iğneleri) tercih edilir. İlaç seçimi yalnızca şeker düşürmeye değil, eşlik eden hastalıklara da göre yapılır.`,
    anahtar: ['diyabet ilaç seçimi', 'SGLT2 böbrek kalp', 'GLP-1 kalp diyabet'],
    kaynaklar: ['ADA Standards of Care in Diabetes (2025)'],
  },
  {
    id: 'dmp-02',
    kategori: 'Prediyabet ve Diyabet',
    soru: 'Diyabetliysem tansiyon ve kolesterol hedeflerim farklı mı?',
    cevap: `Genellikle evet. Diyabette tansiyon hedefi çoğu kişide 130/80 mmHg altıdır ve 40-75 yaş arası diyabetlilerde kalp-damar riskini azaltmak için sıklıkla statin önerilir. Hedefler kişisel duruma göre belirlenir.`,
    anahtar: ['diyabette tansiyon hedefi', 'diyabette statin', 'diyabet kolesterol'],
    kaynaklar: ['ADA Standards of Care in Diabetes (2025)'],
  },
  {
    id: 'lipp-01',
    kategori: 'Kolesterol ve Statinler',
    soru: 'Kötü kolesterol (LDL) hedefim kaç olmalı?',
    cevap: `Hedef, kişisel kalp-damar riskine göre değişir. Kalp krizi veya damar hastalığı geçirenlerde ve en yüksek risklilerde hedef daha düşüktür (LDL genellikle 55 mg/dL altı); yüksek riskte ~70, orta riskte ~100 mg/dL altı hedeflenir. Güncel kılavuz "daha erken, daha düşük, daha uzun süre" yaklaşımını vurgular.`,
    anahtar: ['LDL hedefi', 'kötü kolesterol kaç olmalı', 'kolesterol hedef değer'],
    kaynaklar: ['2026 ACC/AHA Dislipidemi Kılavuzu (Circulation, 2026)'],
  },
  {
    id: 'lipp-02',
    kategori: 'Kolesterol ve Statinler',
    soru: 'Statin tek başına yetmezse başka seçenek var mı?',
    cevap: `Evet. Statinle hedefe ulaşılamazsa ezetimib, gerekirse PCSK9 inhibitörü (iğne) eklenebilir; statini tolere edemeyenlerde bempedoik asit bir seçenektir. Amaç, LDL'yi yeterince ve kalıcı biçimde düşürmektir.`,
    anahtar: ['statin yetmiyor', 'ezetimib PCSK9', 'kolesterol ilaç seçenekleri'],
    kaynaklar: ['2026 ACC/AHA Dislipidemi Kılavuzu (Circulation, 2026)'],
  },
  {
    id: 'lipp-03',
    kategori: 'Kolesterol ve Statinler',
    soru: 'Lp(a) nedir, baktırmam gerekir mi?',
    cevap: `Lp(a), büyük ölçüde genetik olarak belirlenen bir kolesterol parçacığıdır; yüksekliği kalp-damar riskini artırır. Güncel kılavuzlar yaşam boyu en az bir kez ölçülmesini öneriyor; sonuç, riskinizi daha iyi değerlendirmeye yardımcı olur.`,
    anahtar: ['Lp(a) nedir', 'lipoprotein a', 'Lp(a) test'],
    kaynaklar: ['2026 ACC/AHA Dislipidemi Kılavuzu (Circulation, 2026)'],
  },
];
